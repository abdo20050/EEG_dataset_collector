...
def display_image(images_path, label_generator , image_duration = 5000, break_duration = 2000, markerObj = None):
    #non local variables
    break_time = True
    curLabel = "break"
