...
import time
import threading
import visualize as visualizer
class Marker():
    ...
    def add_markers(self):
        ...
        visualizer.display_image(image_paths, label_generator ,image_duration = image_duration, break_duration = 2000, markerObj= self)
        # self.stop_record()
        return
...
#   - In the case you borrow license from , you need to add license = "xxx-yyy-zzz" as init parameter
...
def main():
    ...
    m.record_title = 'Abdullah_data_set' # required param and can not be empty
    ...
    m.record_export_folder = 'D:/emotive/cortex-example/python/records' # your place to export, you should have write permission, example on desktop
